...
protector = {}
protector.mod = "redo"
protector.radius = tonumber(minetest.setting_get("protector_radius")) or 53
...
protector.generate_formspec = function(meta)
	...
	local formspec = "size[8,7]"
		...
		.. default.gui_bg_img
		.. default.gui_slots
		.. "label[2.5,0;" .. S("-- interface of Protector --") .. "]"
		.. "label[0,1;" .. S("To add members you need to add their name. Example, (ManElevation)") .. "]"
